...
export default function PlacePage(){
    ...
    // to access data of the particular id
            ...
            <div className="absolute inset-0 bg-black text-white min-h-screen ">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        ...
                        <button onClick={()=>setShowAllPhotos(false)} className="fixed flex gap-1 py-2 px-4 rounded-2xl text-black shadow shadow-black bg-white right-12 top-8">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
          ...
          <div className=" grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden ">
            ...
            {place.photos?.[1] && (
                ...
                {/* to avoid img to be on different levels */}
            ...
            <button onClick={()=>setShowAllPhotos(true)} className=" flex gap-1 absolute bottom-2 right-2 rounded-2xl py-2 px-4 bg-white shadow-md shadow-gray-500 ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
